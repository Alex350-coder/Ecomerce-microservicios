      ...
      <div className="terms-page">
        ...
        <Card className="terms-content">
          <section className="terms-section">
            ...
            <p>
              Al acceder y utilizar ElectroShop, aceptas estar sujeto a estos Términos de Servicio y
          ...
          <section className="terms-section">
            ...
            <p>
              ...
              restringir el acceso a tu computadora.
            </p>
          </section>
          ...
          <section className="terms-section">
            ...
            <p>
              Todos los pagos se procesan de forma segura. Aceptamos los métodos de pago
              especificados en nuestro sitio web.
            </p>
          </section>
          ...
          <section className="terms-section">
            ...
            <p>
              ...
              retrasos causados por el transportista.
            </p>
          </section>
          ...
          <section className="terms-section">
            ...
            <p>
              Todo el contenido de ElectroShop, incluyendo logotipos, textos y diseños, está
          ...
          <section className="terms-section">
            ...
            <p>
              ElectroShop no será responsable por daños indirectos, incidentales o consecuentes
              resultantes del uso de nuestros servicios.
            </p>
          </section>
